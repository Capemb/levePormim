          ...
          <div class="col-lg">
            <div class="container-tight">
              <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark">DelaPraCa<img src="./static/logo.svg" height="36" alt=""></a>
              </div>
                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('login') }}" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" id="email" class="form-control" name="email" :value="old('email')"  placeholder="your@email.com" autocomplete="off">
