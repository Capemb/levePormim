            ...
            <div class="card">
              <div class="row g-0">
                ...
                <div class="col-12 col-md-9 d-flex flex-column">
                  <div class="card-body">
                    <h2 class="mb-4">{{ $motoboy->primeiro_nome}} {{ $motoboy->ultimo_nome}} </h2>
                    <h3 class="card-title">Detalhe do Perfil</h3>
                    <div class="row align-items-center">
                    ...
                    <form action="{{ route('motoboy.update', $motoboy->id) }}" method="post">
                      @csrf
                    <div class="row g-3">
                      
                      <div class="col-md">
                        <div class="form-label">Primeiro Nome</div>
                        <input type="text" class="form-control" name="primeiro_nome" value="{{ $motoboy->primeiro_nome}} ">
                      </div>
                      <div class="col-md">
                        <div class="form-label">Ultimo Nome</div>
                        <input type="text" class="form-control" name="ultimo_nome" value="{{ $motoboy->ultimo_nome}} ">
                      </div>
                      <div class="col-md">
                        <div class="form-label">Zona de Serviço</div>
                        <input type="text" class="form-control" name="zona_servico"
			       value="{{ $motoboy->zona_servico}} ">
                      </div>
                     <div class="row g-3"> 

                         <div class="col-md">
                        <div class="form-label">Telefone Principal</div>
                        <input type="text" class="form-control" name="telefone_principal"
			       value="{{ $motoboy->telefone_principal}} " required>
                      </div>
                       <div class="col-md">
                        <div class="form-label">Telefone alternativo </div>
                        <input type="text" class="form-control" name="telefone_altenativo" 
			       value="{{ $motoboy->telefone_altenativo}} " required>
                      </div>
                      <div class="col-md">
                        <div class="form-label">Matricula </div>
                        <input type="text" class="form-control"
			       value="{{ $motoboy->matricula}} " name="matricula" required>
                      </div>
                       <div class="col-md">
                        <div class="form-label">Data de inicio</div>
                        <input type="date"  class="form-control" 
                          data-mask-visible="true" placeholder="00/00/0000"autocomplete="off" value="{{ $motoboy->data_inicio}}" name="data_inicio" required/>
                      </div>
                     </div>
                  ...
                  <div class="card-footer bg-transparent mt-auto">
                    <div class="btn-list justify-content-end">
                      <a href="{{ route('motoboy') }}" class="btn">
                       Cancelar
                      </a>
